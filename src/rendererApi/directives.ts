 ...
 *
 * Directives describe things a renderer has no stylesheet properties for, such
 * as the drawing surface and the layout, so they are consumed by the renderer
 * directly and never emitted as a CSS selector. Style tags resolve with the same
